    ...
    return <div className="h-screen flex justify-center flex-col">
        ...
        <a href="#" className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 ">
                <div>
                    ...
                    <div className="pt-2">
                        <LabelledInput label="Username" placeholder="devansh10@gmail.com" />
                        <LabelledInput label="Password" type={"password"} placeholder="********" />
                        <button type="button" className="mt-8 w-full text-white bg-blue-600 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2">Sign in</button>
                    </div>
                </div>
            </a>
        </div>
