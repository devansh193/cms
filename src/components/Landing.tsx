  ...
  return (
    <main className="flex items-center justify-center flex-col">
        <div className="py-40 mx-auto text-center flex flex-col items-center max-w-3xl m-15">
          ...
          <h1 className="text-blue-600 font-bold text-6xl tracking-tight sm:text-6xl">100x Devs</h1>
          <TypewriterEffectSmooth words={words} />
          <p className="mt-6 text-gray-500 max-w-prose font-semibold text-mutates-foreground text-2xl">
            A Beginner-Friendly Platform for Mastering Programming Skills and Unleashing Your Inner Developer Genius!
            Start Learning Today and Transform into a Tech Pro Tomorrow!
          </p>
          <div className="flex flex-col sm:flex-row gap-4 mt-6">
            <Button className="mt-6 rounded-full hover:shadow-sm" size={'lg'} asChild>
              <Link href='/courses'>
